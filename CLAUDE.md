...
Produktdokumentasjon (hva appen *kan*, status, dataflyt): [docs/ROADMAP.md](docs/ROADMAP.md) (historisk «Ferdig»-status er fortsatt gyldig; prioritert rekkefølge for neste produktfase er nå GitHub issue #78, «ROADMAP V2 — Product Phase», se pekeren øverst i filen). Autoritativ kilde for **gjeldende** implementasjons-/livssyklustilstand er GitHub master pluss aktive Issues/PR-er (roadmap-retning: issue #78) — `docs/PROJECT_STATUS_*.md`, inkl. nyeste [docs/PROJECT_STATUS_AUGUST_2026.md](docs/PROJECT_STATUS_AUGUST_2026.md), er punkt-i-tid-historikk (jf. issue #99), ikke løpende teknisk sannhet. Se også [docs/MASTER_DATA_FLOW.md](docs/MASTER_DATA_FLOW.md).
