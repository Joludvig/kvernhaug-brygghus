...
*Dato: 2026-07-28*
*Statusgrunnlag — siste kodecommit dette dokumentet ble skrevet mot: `8abfb15` (ikke nødvendigvis branch-HEAD: en dokumentasjonscommit kan strukturelt aldri pålitelig oppgi sin egen, endelige hash, og ev. senere commits — inkludert denne selv — kommer etter dette punktet)*
*Testantall: 581 tester — 0 skipped, 0 errors, 0 failures*
*Python-filer i repoet: 106*
...
- **`tests/`** — 50 testfiler, inkludert committede fixtures (sanitiserte oppskrift-kopier uten personlig innhold) slik at ingen test er avhengig av private, lokale data.
