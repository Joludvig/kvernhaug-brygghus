...
| 2026-08-10 | [2026-08-10_Web_V1_Pre_Deploy.md](2026-08-10_Web_V1_Pre_Deploy.md) | Web-versjon V1 ferdig (oppskriftsbygger, BJCP-stilmatch, søkbare felt, redesign), nettleser-testet — fryst rett før hosting/deploy og rett etter kartlegging av smakshjul/BJCP-dekning/ingrediensdata |
| 2026-08-10 | [2026-08-10_Web_Laerling_Mester_Ferdig.md](2026-08-10_Web_Laerling_Mester_Ferdig.md) | Smakshjul, BJCP-metadatafiks og delt ingrediensdata, deretter Bryggelærling/Bryggmester-moduser, hjelpetekster, stilveiledning og egendefinerte ingredienser ferdig og testet (HEAD `d974772`) — fryst rett før neste web-runde (Hjelp/FAQ, bryggedagsguide, brukeridentitet, utskriftsmaler) |
| 2026-08-10 | [2026-08-10_Web_Runde_6_Ferdig_Pre_Deploy.md](2026-08-10_Web_Runde_6_Ferdig_Pre_Deploy.md) | Web Runde 6 ferdig og testet (HEAD `14668af`): Hjelp & bryggehåndbok, «?→Les mer», brukeridentitet, fire utskriftsdokumenter, proveniensrettet BrewZilla-guide — fryst rett før en egen, ikke påbegynt Pre-deploy/lanseringsklar-vurdering |
| 2026-08-12 | [2026-08-12_Web_Desktop_Runde_11B_Checkpoint.md](2026-08-12_Web_Desktop_Runde_11B_Checkpoint.md) | Web + desktop checkpoint etter Runde 8–11B: fullbredde hero-header, bredere Oppskriftsbygger-layout, nytt recipe card-oppsett (Smaksprofil/Stilanalyse), Bryggelærling/Bryggmester som reelle modi med kg↔%-arbeidsflyt og mål-IBU→gram, nytt felles KBH Emblem for web og desktop — fryst rett før commit av flere økters uncommittet arbeid og før neste feature-runde |
| 2026-08-15 | [2026-08-15_KBH_Core_Contract_V1.md](2026-08-15_KBH_Core_Contract_V1.md) | KBH Core Contract V1 (Runde 26D–26F): `docs/development/KBH_CORE_CONTRACT.md` etablert, ren adapter `modules/kbh_contract.py`, Streamlit-eksport til `.kbhrecipe` via ny knapp i `ui/recipe_card.py`, 929 tester grønt — fryst rett etter push til `origin/master`, før prosjektet parkeres |
