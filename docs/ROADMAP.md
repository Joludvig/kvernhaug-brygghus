...
*Sist oppdatert: 2026-08-14 (Web Runde 13/13A — portabel .kbhrecipe-fil + «Ny oppskrift»/trygg kladd-erstatning, godkjent og committet). Se `docs/PROJECT_STATUS_JULI_2026.md` for full status, nøkkeltall og kjent teknisk gjeld.*
