...
TEKSTER = {
    "no": {
        ...
        "bryggeskole.prosess.kompakt": "Miljø: {miljo}",
        "bryggeskole.start_leksjon": "▶️ Start leksjon: Gjæringstemperatur",
        "bryggeskole.leksjon.heading": "📖 Gjæringstemperatur",
        "bryggeskole.leksjon.start_sporsmal": "▶️ Start spørsmål",
        "bryggeskole.sporsmal.fremdrift": "Spørsmål {n} av {totalt}",
        ...
        "bryggeskole.oppsummering.heading": "🌱 Din forståelse over tid",
        "bryggeskole.oppsummering.heading_forklaring": "Bygger seg opp over flere runder — endres ikke nødvendigvis av denne ene runden alene.",
        "bryggeskole.oppsummering.denne_runden_heading": "📋 Denne runden",
    ...
    "en": {
        ...
        "bryggeskole.prosess.kompakt": "Environment: {miljo}",
        "bryggeskole.start_leksjon": "▶️ Start lesson: Fermentation temperature",
        "bryggeskole.leksjon.heading": "📖 Fermentation temperature",
        "bryggeskole.leksjon.start_sporsmal": "▶️ Start questions",
        "bryggeskole.sporsmal.fremdrift": "Question {n} of {totalt}",
        ...
        "bryggeskole.oppsummering.heading": "🌱 Your understanding over time",
        "bryggeskole.oppsummering.heading_forklaring": "Builds up across rounds — does not necessarily change from this one round alone.",
        "bryggeskole.oppsummering.denne_runden_heading": "📋 This round",
