...
TEKSTER = {
    "no": {
        ...
        "bryggeskole.modul.metodevalg.tittel": "Forberedelse/metode",
        "bryggeskole.modul.mesking.tittel": "Mesking",
        "bryggeskole.modul.koking.tittel": "Koking",
        "bryggeskole.modul.kjoling.tittel": "Kjøling/overføring",
        "bryggeskole.modul.gjaring.tittel": "Gjæring",
        "bryggeskole.modul.pakking.tittel": "Pakking",
        ...
        "brew_history.learning_hypothesis_label": "Mulig forklaring (hypotese)",
        "brew_history.learning_hypothesis_caption": "En mulig forklaring på det du opplevde — ikke en fastslått årsak.",
        ...
        "brew_history.neste_variant_tittel": "🌱 Neste variant",
        "brew_history.neste_variant_krever_next_time": "Fyll inn og lagre «Neste gang» over for å aktivere denne handlingen.",
        ...
        "brew_history.neste_variant_lenke_knapp": "🔗 Lagre kobling",
        "brew_history.neste_variant_lenke_lagret_ok": "✅ Kobling lagret.",
    ...
    "en": {
        ...
        "bryggeskole.modul.metodevalg.tittel": "Preparation/method",
        "bryggeskole.modul.mesking.tittel": "Mashing",
        "bryggeskole.modul.koking.tittel": "Boil",
        "bryggeskole.modul.kjoling.tittel": "Cooling/transfer",
        "bryggeskole.modul.gjaring.tittel": "Fermentation",
        "bryggeskole.modul.pakking.tittel": "Packaging",
        "bryggeskole.modul.start": "▶️ Start",
        ...
        "brew_history.learning_hypothesis_label": "Possible explanation (hypothesis)",
        "brew_history.learning_hypothesis_caption": "A possible explanation for what you observed — not an established cause.",
        ...
        "brew_history.neste_variant_tittel": "🌱 Next variant",
        "brew_history.neste_variant_krever_next_time": "Fill in and save «Next time» above to enable this action.",
        ...
        "brew_history.neste_variant_lenke_knapp": "🔗 Save link",
        "brew_history.neste_variant_lenke_lagret_ok": "✅ Link saved.",
