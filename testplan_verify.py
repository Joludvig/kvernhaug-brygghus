...
Kjøres manuelt fra repo-roten:
    py -3 testplan_verify.py

Alt kjørende innhold ligger bak `if __name__ == "__main__":` slik at filen
er trygg å importere (bl.a. av `py -3 -m unittest discover`, som ellers ville
plukket den opp fordi navnet matcher "test*.py").
"""
import json
import os
