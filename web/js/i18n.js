...
const TEKSTER = {
  no: {
    ...
    "hjelp.dag.steg13.folgMed": "Aktivitet i gjæringslåsen de første dagene, og at temperaturen holder seg innenfor gjærens anbefalte område. Unngå å røre eller overføre ølet mer enn nødvendig — oksygenkontakt fra dette punktet kan gi oksidasjon, som skader aroma, smak og holdbarhet.",
  ...
  en: {
    ...
    "hjelp.dag.steg13.folgMed": "Activity in the airlock over the first few days, and that the temperature stays within the yeast's recommended range. Avoid disturbing or transferring the beer more than necessary — oxygen contact from this point on can cause oxidation, which harms aroma, flavor, and shelf life.",
