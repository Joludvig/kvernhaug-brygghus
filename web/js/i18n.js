...
const TEKSTER = {
  no: {
    ...
    "utstyr.felt.kjelekapasitet": "Kjelekapasitet (L)",
    "utstyr.felt.anbefaltMaks": "Anbefalt maks batchvolum (L)",
    ...
    "utstyr.detaljKapasitet": "{kap} L kjele",
    "utstyr.detaljMaks": "maks {maks} L anbefalt",
    "utstyr.batchAdvarsel": "Dette batchvolumet er større enn anbefalt maks for {navn} ({maks} L). Oppskriften kan fortsatt brukes, men kontroller at bryggeutstyret har nok kapasitet.",
  ...
  en: {
    ...
    "utstyr.felt.kjelekapasitet": "Kettle capacity (L)",
    "utstyr.felt.anbefaltMaks": "Recommended max batch size (L)",
    ...
    "utstyr.detaljKapasitet": "{kap} L kettle",
    "utstyr.detaljMaks": "max {maks} L recommended",
    "utstyr.batchAdvarsel": "This batch volume is larger than the recommended max for {navn} ({maks} L). The recipe still works, but double-check your brewing equipment has enough capacity.",
