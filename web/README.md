...
web/
  ...
  assets/branding/kvernhaug_logo_kompakt.png   Lite nav-/drawer-ikon (kråke + kvernhjul), uendret siden polish-runden
...
- **To atskilte logo-roller**: et lite **nav-/drawer-ikon** (`web/assets/branding/kvernhaug_logo_kompakt.png`, mastheaden + venstremenyen) og et **fullt emblem** (høyrekortets identitetsblokk). Nav-ikonet er uendret siden polish-runden 2026-08-10 — en sirkulær 400×400 beskjæring av kråke + kvernhjul fra `assets/branding/master_v1_crop.png` (kildefil: `assets/branding/kompaktlogo_kraake_kvern.png`). Det er bevisst en automatisk beskjæring, ikke den formelt komponerte rundmedaljongen (kråke + vannhjul + buet `KVERNHAUG BRYGGHUS`-tekst) som `docs/branding/master_design_v1.md` beskriver — den asseten finnes ikke i repoet ennå og er egen, bevisst designjobb (se backlog i `docs/ROADMAP.md`).
